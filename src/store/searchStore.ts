...
// Get recent searches from localStorage (SSR-safe)
...
// Save recent searches to localStorage (SSR-safe)
...
export const useSearchStore = create<SearchState>((set, get) => ({
  ...
  error: null,
  isOpen: false,
  recentSearches: [], // Will be populated on client
  pagination: {
    page: 1,
    limit: 20,
    total: 0,
  ...
  // Initialize recent searches on client
  initRecentSearches: () => {
    set({ recentSearches: getStoredRecentSearches() });
  },
