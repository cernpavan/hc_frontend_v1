      ...
      <div className="bg-dark-900 border border-dark-700 rounded-t-2xl md:rounded-2xl w-full max-w-md shadow-2xl animate-in max-h-[80vh] flex flex-col safe-area-bottom">
        ...
        <div className="p-4 border-b border-dark-800 flex-shrink-0">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={isHindiLang ? 'समुदाय खोजें...' : isPunjabiLang ? 'ਭਾਈਚਾਰੇ ਖੋਜੋ...' : 'Search communities...'}
              value={searchQuery}
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-dark-400">
                {searchQuery
                  ? (isHindiLang ? 'कोई समुदाय नहीं मिला' : isPunjabiLang ? 'ਕੋਈ ਭਾਈਚਾਰਾ ਨਹੀਂ ਮਿਲਿਆ' : 'No communities found')
                  : (isHindiLang ? 'कोई समुदाय उपलब्ध नहीं' : isPunjabiLang ? 'ਕੋਈ ਭਾਈਚਾਰਾ ਉਪਲਬਧ ਨਹੀਂ' : 'No communities available')
                }
              </p>
            </div>
          ) : (
