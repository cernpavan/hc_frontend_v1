...
export default function CommentCard({
  ...
  const content = showTranslation
    ? (currentLanguage === 'hindi' ? comment.contentTranslated?.hindi : currentLanguage === 'punjabi' ? comment.contentTranslated?.punjabi : comment.contentTranslated?.english) || comment.content
    : comment.content;
