...
const TAG_LABELS: Record<string, { en: string; hi: string; pa: string }> = {
...
export default function SearchResults() {
  ...
  const currentLanguage = isAuthenticated
    ? user?.language
    : (typeof window !== 'undefined' ? localStorage.getItem('guest-language') : null) || 'hindi';
  ...
  const getTagLabel = (tag: string) => {
    ...
    return isHindiLang ? labels.hi : isPunjabiLang ? labels.pa : labels.en;
  };
