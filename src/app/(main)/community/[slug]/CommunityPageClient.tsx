...
import { Clock, Flame, Heart, Loader2, MessageCircle, PlusCircle, Users } from 'lucide-react';
                ...
                <div className="flex gap-2 overflow-x-auto pb-1 sm:pb-0 sm:flex-wrap scrollbar-hide -mx-1 px-1">
                    {filters.map((f) => (
                        <button
                            ...
                            className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg whitespace-nowrap transition-colors min-h-[44px] text-sm sm:text-base flex-shrink-0 sm:flex-shrink ${filter === f.id
