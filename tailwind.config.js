  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        punjabi: ['Noto Sans Gurmukhi', 'Raavi', 'sans-serif'],
      },
      fontSize: {
        ...
        // Hindi/Devanagari-optimized sizes (slightly larger for readability)
        'hi-sm': ['0.9375rem', { lineHeight: '1.5rem' }],
        'hi-base': ['1.0625rem', { lineHeight: '1.75rem' }],
        'hi-lg': ['1.1875rem', { lineHeight: '2rem' }],
        // Punjabi/Gurmukhi-optimized sizes
        'pa-sm': ['0.9375rem', { lineHeight: '1.5rem' }],
        'pa-base': ['1.0625rem', { lineHeight: '1.75rem' }],
        'pa-lg': ['1.1875rem', { lineHeight: '2rem' }],
      },
      spacing: {
